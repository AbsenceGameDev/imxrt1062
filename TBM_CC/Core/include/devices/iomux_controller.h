...
/** @brief Mux Pad Field Masks (Slew Rate Field) */
typedef enum
{
...
/** @brief Mux Pad Field Masks (Drive Strength Field) */
typedef enum
{
...
/** @brief Mux Pad Field Masks (Speed/Freq Field) */
typedef enum
{
  PAD_SPEED_50MHz = 0x0,
...
/** @brief Mux Pad Field Masks (Open Drain Field) */
typedef enum
{
...
/** @brief Mux Pad Field Masks (Pull/Keep Enable Field) */
typedef enum
{
...
/** @brief Mux Pad Field Masks (Pull/Keep Select Field) */
typedef enum
{
  PAD_KEEPER = 0x0,
  PAD_PULLER = 0x1
...
/** @brief Mux Pad Field Masks (Pull Up/Down Config. Field) */
typedef enum
{
...
/** @brief Mux Pad Field Masks (Hysteresis Enable Field) */
typedef enum
{
  HYS_0_DISABLED = 0x0,
  HYS_1_ENABLED = 0x1
...
// 32bit + 32bit + 24bit
// 11 bytes wihtout padding
#define MUXDEVICE_BYTESIZE ((uint8_t)0xc) // an extra byte for good measure, @todo consider using offsetof

// Function to initialize the device
void init_device_muxmode(muxdev_s* mux_device,
                    vuint32_t*     sw_mux,
                    vuint32_t*     sw_pad,
...
// Function to set the mux mode of the given device
void
