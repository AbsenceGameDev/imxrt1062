...
/**
 *
 * 0x0000 Version ID (VERID)
 * 0x0004 Parameter (PARAM)
 * 0x0008 FlexIO Control (CTRL)
 * 0x0000 hPin State (PIN)
 * 0x0010 Shifter Status (SHIFTSTAT)
 * 0x0014 Shifter Error (SHIFTERR)
 * 0x0018 Timer Status (TIMSTAT)
 * 0x0020 Shifter Status Interrupt Enable (SHIFTSIEN)
 * 0x0024 Shifter Error Interrupt Enable (SHIFTEIEN)
 * 0x0028 Timer Interrupt Enable (TIMIEN)
 * 0x0030 Shifter Status DMA Enable (SHIFTSDEN)
 * 0x0040 Shifter State (SHIFTSTATE)
 *
